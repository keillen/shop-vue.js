		...
		<div class="wrap">
			<div id="content">
				...
				<div class="item">
					<div class="album">
						<div class="album-mid">
							<img class="album-mid-img" alt="预览图" :src="'../../static/upload/'+goodsOne[0].pic">
						...
						<div class="album-small">
							...
							<div class="album-list">
								<ul>
									<li class="album-curr"><img :src="'../../static/upload/'+goodsOne[0].pic" alt="预览图"></li>
								</ul>
							</div>
					...
					<div class="item-info">
						<h1>{{goodsOne[0].title}}</h1>
						<div class="item-info-sell">{{goodsOne[0].sell_point}}</div>
						<table>
							<tbody>
								<tr>
									<th>售 价：</th>
									<td><span class="item-info-price">¥&nbsp;{{goodsOne[0].price}}</span></td>
								</tr>
								<tr>
									<th>累计销量：</th>
									<td>0</td>
								...
								<tr>
									...
									<td>
										...
										<span class="item-num-stock">{{goodsOne[0].num}}</span>   ）
									</td>
								</tr>
								<tr>
									<td colspan="2" class="item-info-button">
										<a href="#" class="light">立即购买</a>
                    <a @click="routerTo()" id="cart_add">加入购物车</a>
									</td>
								</tr>
							</tbody>
						</table>
					...
					<div class="item-ads">
						...
						<div class="item-ads-content">
							...
							<ul class="item-ads-item" v-for="recommended in recommendeds" v-show="recommended.id>35&recommended.id<39">
								<li>
									<router-link target="_blank" v-bind:to="'/goodsInformation/'+recommended.id">
										<img :src="'../../static/upload/'+recommended.pic" alt="+recommended.title+">
									</router-link>
								</li>
								...
								<li class="item-ads-price">¥{{recommended.price}}</li>
							</ul>
					...
					<div class="item-desc">
						...
						<div class="item-desc-content" v-html="goodsOne[0].content">
						</div>
					</div>
					<div class="item-line"></div>
				</div>
...
//				goodsId:-1,
      ...
      routerTo() {
        ...
        this.$router.push({
          ...
          params: {
            ...
            price : this.goodsOne[0].price,
            title : this.goodsOne[0].title
      }
        })
      },
      subNumber(){
      ...
      addNumber(){
          this.goodsNumber++
			...
			fetchGoodsId(id){
				this.$http.get("http://localhost:8088/item/sid/"+id)
			...
			fetchRecommended(){
				this.$http.get("http://localhost:8088/item/si")
	  				.then(function(response){
...
//			this.goodsId = this.$route.params.id
			this.fetchGoodsId(this.$route.params.id)
